...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('cf', 16)->nullable()->comment('Nome completo (denormalizzato per velocità)');
            ...
            $table->unsignedInteger('company_branche_id')->nullable()->index('company_branche_id')->comment('Sede fisica di assegnazione');
