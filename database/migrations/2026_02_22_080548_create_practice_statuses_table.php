...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('practice_statuses', function (Blueprint $table) {
            ...
            $table->increments('id');
            $table->unsignedInteger('practice_id')->index('practice_id')->comment('La pratica a cui si riferisce il cambio di stato');
            ...
            $table->unsignedInteger('changed_by')->index('changed_by')->comment('L\'utente (backoffice/admin) che ha aggiornato lo stato');
