...
class DocumentTypeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = [
            ...
            'doc_18' => ['name' => 'Guida ABF in parole semplici', 'description' => "Guida pratica sull'Arbitro Bancario Finanziario", 'slug' => 'guida-abf', 'regex' => '/abf.*parole.*semplici|arbitro.*bancario/i', 'is_company' => 1],
            'doc_19' => ['name' => 'Guida Centrale dei Rischi', 'description' => "Guida della Banca d'Italia sulla Centrale dei Rischi", 'slug' => 'guida-centrale-rischi', 'regex' => '/guida.*centrale.*rischi/i', 'is_company' => 1],
            'doc_20' => ['name' => 'Guida IVASS Polizze Mutui e Finanziamenti', 'description' => 'Guida IVASS per le polizze abbinate a mutui e finanziamenti (PPI)', 'slug' => 'guida-ivass-polizze', 'regex' => '/guida.*polizze.*mutuo|polizze.*finanziamenti.*ivass/i', 'is_company' => 1],
            'doc_21' => ['name' => 'Guida Comprare Casa - Mutuo Ipotecario', 'description' => "Guida Banca d'Italia: Il mutuo ipotecario in parole semplici", 'slug' => 'guida-mutuo-ipotecario', 'regex' => '/comprare.*casa|mutuo.*ipotecario.*parole.*semplici/i', 'is_company' => 1],
            'doc_22' => ['name' => 'Guida Credito ai Consumatori', 'description' => "Guida Banca d'Italia: Il credito ai consumatori in parole semplici", 'slug' => 'guida-credito-consumatori', 'regex' => '/credito.*consumatori.*parole.*semplici/i', 'is_company' => 1],
        ];
